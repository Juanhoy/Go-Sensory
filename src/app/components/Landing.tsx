    ...
    <div className="min-h-screen bg-[#F5F2ED] flex flex-col items-center justify-center px-6">
      ...
      <form onSubmit={handleLogin} className="w-full max-w-md space-y-4">
        ...
        <input
          ...
          className="w-full bg-[#E8E4DB] rounded-full px-6 py-4 outline-none placeholder:text-gray-500"
        />
        ...
        <button
          type="submit"
          className="w-full bg-[#9BC9BB] rounded-full py-4 text-lg"
        >
          Login
        </button>
